...
export function frameReportsSidebarCollapsed(): boolean {
 ...
 */
export function isRealSessionSelection(
  enabled: boolean,
...
export class AutoCollapseMachine {
  ...
  lastDecision: CollapseDecision = 'ignored'
  ...
  #suppressFor: string | undefined = undefined
   ...
   */
  constructor(
    private readonly isCollapsed: ReadSidebarCollapsed = frameReportsSidebarCollapsed,
    private readonly collapse: CollapseSidebar = () => {},
  ) {}
